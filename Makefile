...
# Yang: merge CXXOPTIMFLAGS together
...
# Yang: add -g back here
MEXFLAGS_CPU += CXXOPTIMFLAGS='$$CXXOPTIMFLAGS -g -mssse3 -ftree-vect-loop-version -ffast-math -funroll-all-loops'
MEXFLAGS_GPU += CXXOPTIMFLAGS='$$CXXOPTIMFLAGS -Xcompiler -g,-mssse3,-ftree-vect-loop-version,-ffast-math,-funroll-all-loops'
...
# Yang: add my reader in
mex_src+=matlab/src/vl_imreadjpeg_gpu.cpp
endif
